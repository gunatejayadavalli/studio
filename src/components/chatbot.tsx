...
export function Chatbot({ booking, property, host, insurancePlan, eligiblePlan }: ChatbotProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Card className="w-full max-w-sm md:w-[400px] h-[500px] min-w-[384px] md:min-w-[400px] min-h-[500px] shadow-2xl flex flex-col resize overflow-hidden transform rotate-180">
