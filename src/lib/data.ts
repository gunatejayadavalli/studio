...
export const initialUsers: User[] = [
  { id: '1', name: 'Alex Doe', email: 'alex@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&fit=crop', isHost: true },
  { id: '2', name: 'Sam Smith', email: 'sam@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop', isHost: false },
  { id: '3', name: 'Casey Jones', email: 'casey@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop', isHost: true },
  { id: '4', name: 'Riley Brown', email: 'riley@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop', isHost: false },
  { id: '5', name: 'Jordan Lee', email: 'jordan@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop', isHost: false },
  { id: '6', name: 'Morgan Taylor', email: 'morgan@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1554151228-14d9def656e4?w=100&h=100&fit=crop', isHost: true },
  { id: '7', name: 'Taylor Green', email: 'taylor@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&h=100&fit=crop', isHost: true },
  { id: '8', name: 'Chris Pine', email: 'chris@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop', isHost: false },
  { id: '9', name: 'Pat River', email: 'pat@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop', isHost: true },
  { id: '10', name: 'Jamie Blue', email: 'jamie@example.com', password: 'password123', avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&h=100&fit=crop', isHost: false },
];
