...
export const users: User[] = [
  ...
  { id: '7', name: 'Taylor Green', email: 'taylor@example.com', avatar: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=100&h=100&fit=crop', isHost: true },
...
export const properties: Property[] = [
  ...
  },
  {
    ...
    pricePerNight: 180,
    rating: 4.8,
    thumbnail: 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'urban studio',
    images: ['https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=1200&h=800&auto=format&fit=crop'],
  ...
  },
  {
    ...
    pricePerNight: 250,
    rating: 4.95,
    thumbnail: 'https://images.unsplash.com/photo-1508928375936-8c01a9786968?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'tropical treehouse',
    images: ['https://images.unsplash.com/photo-1508928375936-8c01a9786968?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1555855392-465a39648936?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1543644088-bd1c97c17a23?q=80&w=1200&h=800&auto=format&fit=crop'],
  ...
  },
  {
    ...
    pricePerNight: 550,
    rating: 4.98,
    thumbnail: 'https://images.unsplash.com/photo-1590588998273-04279032f3d2?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'santorini house',
    images: ['https://images.unsplash.com/photo-1590588998273-04279032f3d2?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1569273516305-b33139369342?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A traditional cave house carved into the caldera cliff, offering breathtaking views of the Aegean Sea and the famous Santorini sunset.',
    amenities: ['WiFi', 'Plunge Pool', 'Kitchenette', 'Air Conditioning'],
  },
  {
    id: '11',
    hostId: '9',
    ...
    pricePerNight: 280,
    rating: 4.88,
    thumbnail: 'https://images.unsplash.com/photo-1582772242564-f63b45138244?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'kyoto house',
    images: ['https://images.unsplash.com/photo-1582772242564-f63b45138244?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1622379329432-3f11904944c6?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1593053189953-93a846123491?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'Experience authentic Japanese living in a beautifully restored machiya (traditional wooden townhouse). Features tatami rooms and a private garden.',
    amenities: ['WiFi', 'Kitchen', 'Heating', 'Garden'],
  },
  {
    id: '12',
    hostId: '3',
    title: 'Seattle Floating Houseboat',
    location: 'Seattle, Washington',
    pricePerNight: 260,
    rating: 4.7,
    thumbnail: 'https://images.unsplash.com/photo-1549991262-076412174246?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'seattle houseboat',
    images: ['https://images.unsplash.com/photo-1549991262-076412174246?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1605295325893-6e354767b4c4?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1496247749670-41dd72756a14?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'Live like a local on one of Seattle\'s famous houseboats on Lake Union. Enjoy the gentle rock of the water and views of the city skyline.',
    amenities: ['WiFi', 'Kitchenette', 'Heating', 'Kayak Access'],
  },
  {
    id: '13',
    hostId: '7',
    ...
    pricePerNight: 420,
    rating: 4.95,
    thumbnail: 'https://images.unsplash.com/photo-1585433282838-89585641913c?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'alps chalet',
    images: ['https://images.unsplash.com/photo-1585433282838-89585641913c?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A cozy, traditional Swiss chalet with modern amenities and spectacular views of the Eiger north face. Ski-in, ski-out access in winter.',
  ...
  },
  {
    ...
    pricePerNight: 310,
    rating: 4.81,
    thumbnail: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'austin home',
    images: ['https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A stunning modern home in a quiet Austin neighborhood, just minutes from downtown. Features a pool and a large outdoor patio.',
    amenities: ['WiFi', 'Pool', 'Kitchen', 'Air Conditioning', 'Free Parking'],
  },
  {
    id: '15',
    hostId: '1',
    title: 'Charleston Historic Inn',
    location: 'Charleston, South Carolina',
    pricePerNight: 240,
    rating: 4.9,
    thumbnail: 'https://images.unsplash.com/photo-1555854837-14e34e524597?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'charleston inn',
    images: ['https://images.unsplash.com/photo-1555854837-14e34e524597?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'Stay in a beautifully restored room in a historic inn, located in the heart of Charleston\'s French Quarter. Walk to everything!',
  ...
  },
  {
    ...
    pricePerNight: 380,
    rating: 4.97,
    thumbnail: 'https://images.unsplash.com/photo-1533105079780-52b9be4ac204?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'iceland cabin',
    images: ['https://images.unsplash.com/photo-1533105079780-52b9be4ac204?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1605545248302-b44d7159c3a3?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1508913920945-815a5f113b63?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A remote glass cabin perfect for viewing the Northern Lights. A truly unique and magical experience in the Icelandic wilderness.',
    amenities: ['WiFi', 'Kitchenette', 'Heating', 'Hot Tub'],
  },
  {
    id: '17',
    hostId: '3',
    ...
    pricePerNight: 220,
    rating: 4.85,
    thumbnail: 'https://images.unsplash.com/photo-1585652549223-559e35574044?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'joshua tree dome',
    images: ['https://images.unsplash.com/photo-1585652549223-559e35574044?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1596701712415-32247e7b5f10?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A unique geodesic dome house in the desert. Perfect for stargazing and exploring Joshua Tree National Park.',
    amenities: ['WiFi', 'Kitchen', 'Air Conditioning', 'Fire Pit'],
  },
  {
    id: '18',
    hostId: '7',
    ...
    pricePerNight: 160,
    rating: 4.79,
    thumbnail: 'https://images.unsplash.com/photo-1619716382168-9c1df5615e42?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'savannah apartment',
    images: ['https://images.unsplash.com/photo-1619716382168-9c1df5615e42?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1579789998058-29a383287a95?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1541882244133-289b4f91a27e?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A charming garden-level apartment in a historic Savannah home. Features a private courtyard entrance and is close to Forsyth Park.',
    amenities: ['WiFi', 'Kitchenette', 'Air Conditioning', 'Patio'],
  },
  {
    id: '19',
    hostId: '9',
    title: 'Miami Art Deco Condo',
    location: 'Miami Beach, Florida',
    pricePerNight: 290,
    rating: 4.6,
    thumbnail: 'https://images.unsplash.com/photo-1567016376408-0226e4d0c1ea?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'miami condo',
    images: ['https://images.unsplash.com/photo-1567016376408-0226e4d0c1ea?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1594488939444-3c0041285437?q=80&w=1200&h=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1600585152225-357ea66c7e20?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A stylish condo in a classic Art Deco building, just steps from South Beach. Enjoy the sun, sand, and vibrant nightlife.',
    amenities: ['WiFi', 'Pool', 'Kitchen', 'Air Conditioning'],
  },
  {
    id: '20',
    hostId: '1',
    title: 'Nashville Music Loft',
    location: 'Nashville, Tennessee',
    pricePerNight: 200,
    rating: 4.83,
    thumbnail: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=600&h=400&auto=format&fit=crop',
    data_ai_hint: 'nashville loft',
    images: ['https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=1200&h=800&auto=format&fit=crop'],
    description: 'A cool, music-themed loft in downtown Nashville. Close to Broadway and all the famous honky-tonks. Includes a record player and a collection of vinyl.',
    amenities: ['WiFi', 'Kitchen', 'Air Conditioning', 'Record Player'],
  },
];
...
export const faqs: Faq[] = [
  ...
  },
  {
    id: 'faq8',
    propertyId: '10',
    question: 'How do we get to the property from the port?',
    answer: 'We recommend arranging a transfer. Taxis are available at the port, and the ride takes about 25 minutes. We can also help arrange a private transfer for you.',
  },
  {
    id: 'faq9',
    propertyId: '11',
    question: 'Is the garden private?',
    answer: 'Yes, the small tsubo-niwa (courtyard garden) is completely private for your enjoyment.',
  },
  {
    id: 'faq10',
    propertyId: '16',
    question: 'What are the chances of seeing the Northern Lights?',
    answer: 'The best chances are from September to April on clear nights. The cabin\'s remote location away from city lights provides an excellent viewing opportunity, but sightings are not guaranteed.',
  },
  {
    id: 'faq11',
    propertyId: '20',
    question: 'How close are you to the Ryman Auditorium?',
